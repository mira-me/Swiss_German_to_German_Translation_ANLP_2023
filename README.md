...
**2_training.ipynb**:
* This notebook is run to add a new language to the model and finetune it on the SwissDial training dataset. This notebook is executed with a T4 GPU in Google Colab. The model-used in this project is the [facebook/nllb-200-distilled-600M](https://huggingface.co/facebook/nllb-200-distilled-600M) from Hugging Face. 
...
**4_scores_test_statistics.ipynb**: 
* Notebook to calculate the BLEU, CHRF and TER scores and test statistics.


## Data

* **df_test.csv and df_train.csv**: train and test set used in the notebook 2_training.ipynb and 3_testing.ipynb. The training and test set are generated with the notebook 1_data_preparation.ipynb.
